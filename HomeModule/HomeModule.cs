...
namespace AnimalShelter
{
  public class HomeModule : NancyModule
  {
    public HomeModule()
    {
      ...
      Post["/animals/new"] = _ => {
        Animal newAnimal = new Animal(Request.Form["animal-name"], Request.Form["animal-gender"], Request.Form["animal-date"], Request.Form["animal-breed"], Request.Form["type-id"]);
        newAnimal.Save();
        return View["success.cshtml"];
      };
